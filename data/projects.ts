...
export const retiredProjectSlugs = [
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Use-case notes for bots, aerial planning, and site operations.",
      "Details to be added as concrete prototypes are built."
    ],
    techUsed: ["Workflow design", "Checklist systems", "Automation planning"],
    nextStep: "Prototype one checklist flow inside an automation or aviation workflow page.",
    caseStudyStatus: "coming-soon",
    githubUrl: "",
    liveUrl: "",
    caseStudyUrl: "",
